...
"""
Rock Paper Scissors game using dictionary-based win conditions.
Combines menu system with efficient game logic.
"""
...
# Dictionary to determine what each choice beats
wins_against = {
    'rock': 'scissors',
    'scissors': 'paper',
    'paper': 'rock'
...
def play_game():
    """Play one round using dictionary lookup."""
    ...
    # Use dictionary to determine winner
